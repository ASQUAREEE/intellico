...
export default function Home() {
  return (
   ...
   Chat with your <span className="text-blue-600">documents</span> in seconds.
    ...
    Intellico allows you to have conversations with any PDF document. Simply upload your file and start asking questions right away.
  ...
  })} href={'/dashboard'} target='_blank'>  {/* new tab  */}
...
<Image src='/dashboard-preview.jpg' alt='product preview' width={1364} height={866} quality={100} className="rounded-md bg-white p-2 sm:p-8 md:p-20 shadow-2xl ring-1 ring-gray-900/10" />
...
<span className="mt-2 text-zinc-700">
 It&apos;s that simple. Try out intellico today - it really takes less than a minute.
</span>
...
<Image src='/file-upload-preview.jpg' alt='uploading preview' width={1419} height={732} quality={100} className="rounded-md bg-white p-2 sm:p-8 md:p-20 shadow-2xl ring-1 ring-gray-900/10" />
